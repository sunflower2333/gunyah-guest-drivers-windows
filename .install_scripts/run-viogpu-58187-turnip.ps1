...
param(
    ...
    [string]$InteractiveRunnerPath = 'C:\Users\USER\viogpu-58187-b5b217b1\run-viogpu-58187-win32-interactive.ps1',
    [string]$CaptureScriptPath = 'C:\DroidVM\TurnipRuns\viogpu-58186-c913fd87\capture-turnip-wddm-win32-window.ps1',
    [string]$OutputDirectory = 'C:\DroidVM\TurnipRuns\evidence\viogpu-58187-b5b217b1-turnip',
    [string]$TaskName = 'DroidVM-Turnip-58187-Interactive',
...
$expectedDriverVersion = '100.6.101.58187'
$expectedDriverHash = 'd0320f7bedd739232f761a256d42b11f12f92b6a98551c2140e6efe27ef7543d'
$expectedUmdHash = 'adc830091dc35049b6b4adf5c07d16e8f284b5983787f93d08c7a89b8d898a53'
$expectedInteractiveRunnerHash = '740b493e4c557c68d9e40271766a6106821f8d5f21fd6855583daa8c822a0c9e'
...
function Get-FaultEvents {
    ...
    $systemEvents = @(Get-WinEvent -FilterHashtable @{ LogName = 'System'; StartTime = $Since } `
        -ErrorAction SilentlyContinue | Where-Object {
            $_.Id -in @(14, 17, 18, 19, 41, 1001, 4101, 6008)
        } | Select-Object TimeCreated, Id, ProviderName, LevelDisplayName, Message)
    $applicationEvents = @(Get-WinEvent -FilterHashtable @{ LogName = 'Application'; StartTime = $Since } `
        -ErrorAction SilentlyContinue | Where-Object {
...
try {
    ...
    $faultEvents = Get-FaultEvents $suiteStarted
...
$summary = [ordered]@{
    ...
    Bundle = $bundle
    InteractiveRunnerPath = $InteractiveRunnerPath
    InteractiveRunnerSha256 = $expectedInteractiveRunnerHash
    CaptureScriptPath = $CaptureScriptPath
    CaptureScriptSha256 = $expectedCaptureScriptHash
