...
param(
    ...
    [string]$OutputDirectory = 'C:\DroidVM\TurnipRuns\evidence\viogpu-58186-c913fd87-turnip',
    [string]$TaskName = 'DroidVM-Turnip-58186-Interactive',
...
$expectedInteractiveRunnerHash = 'c9022760c6df3224a20c20d77335df78b5c95d71a66a4f85343d1f49536c8c7b'
