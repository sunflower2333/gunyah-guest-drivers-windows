[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\USER\viogpu-58190-c232ccf3\package',
    [string]$CertificatePath = 'C:\Users\USER\viogpu-58190-c232ccf3\DroidVM_Test.cer',
    [string]$EvidenceRoot = 'C:\Users\USER\viogpu-58190-c232ccf3\evidence',
    [string]$RollbackRoot = 'C:\Users\USER\viogpu-rollback-pre-58190-c232ccf3',
    [switch]$ValidateOnly
)
...
$expectedHashes = [ordered]@{
    'viogpud3d.dll' = '4aef90a8a909f19d7ab10e4874515575cfa20b8ef757c863c8717e814fa86520'
    ...
    'viogpuwddm.sys' = '8ab40857646be6f0e40a0aec7d63bc80190f51af1d7afc5707aeae9b5bbacdf5'
}
$expectedCertificateHash = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
$expectedVersion = '100.6.101.58190'
$expectedBeforeVersion = '100.6.101.58189'
$expectedBeforeInfPath = 'oem25.inf'
$expectedBeforeImageHash = 'e77c64561ce642085e6c85ac962cf5613f6ba124942df53ac7bb0836aefd252c'
$expectedBeforeUmdHash = 'a3f5d72f65ce6957661770ef7892027a569f18470c926accaeee44658ea6404c'
...
function Assert-Package {
    ...
    if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58190') { throw "The staged INF is not version $expectedVersion" }
