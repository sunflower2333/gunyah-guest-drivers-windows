...
param(
    ...
    [string]$OutputPath = 'C:\Users\Administrator\viogpu-58165\pnp-9f-frames.txt'
)
...
$commands = @(
    ...
    'lmvm viogpuwddm'
    '!thread ffffd68585805080 1f'
    '.thread /r /p ffffd68585805080'
    'kn 60'
    '!irp ffffd685857f6ae0 7'
    '!devstack ffffd685872c3030'
    '!devobj ffffd685872c3030'
    'dt nt!_DEVICE_OBJECT ffffd685872c3030'
    '!locks'
    'q'
) -join '; '
