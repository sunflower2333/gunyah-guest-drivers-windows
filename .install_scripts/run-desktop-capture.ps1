[CmdletBinding()]
param(
    [string]$InnerScript = 'C:\DroidVM\agent-scripts\capture-desktop-inner.ps1',
    [string]$OutputDirectory = 'C:\DroidVM\TurnipRuns\evidence-desktop',
    [string]$TaskName = 'DroidVM-Desktop-Capture',
