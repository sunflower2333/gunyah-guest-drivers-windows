...
param(
    ...
    [string]$OutputDirectory = 'C:\Windows\Temp\viogpu-kmt-58075',
...
foreach ($path in @($ProbePath, $CaptureScript)) {
...
if ($driverVersion -ne '100.6.101.58075') {
    throw "Expected active driver version 100.6.101.58075, got '$driverVersion'."
}
