[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\DroidVM\viogpu-58043\viogpu',
    [string]$CertificatePath = 'C:\DroidVM\viogpu-58043\DroidVM_Test.cer',
    [string]$OutputDirectory = 'C:\DroidVM\viogpu-58043\runtime-logs'
)
...
$expectedHashes = [ordered]@{
    'viogpuwddm.sys' = '659013b9a0d39c0c773b46854d016fece0356054b9ff5f61adb5ecc8c35d1e5f'
    'viogpud3d.dll' = 'c972eda0704662709e724dcfb44427ec3668a539cb892961c01cfa0144e242eb'
    'viogpuwddm.cat' = '1b06a8bcc6b082122284c5c840719c050a80f7c4a5d3640c1996032c093926d8'
    'viogpuwddm.inf' = 'c048bd52b08ebf97be1b15b6a307f7e773910e743a4b615ec653577b4bc7c74d'
    'viogpuwddm.pdb' = 'c410ab07b9c0014bf1e517f801dc8ba3fcc9fc5c25fdc7f9b02d448e4c406a37'
    'viogpuwddm.map' = 'db92fbccfe6182546c837824d46e613901eceb8c5b25d9c22696465b0702001e'
    'viogpud3d.pdb' = 'f92961a1b2cad6641038a18119df3b6c08391660b45ce8fcd6f9b607bfbe841d'
}
...
if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58043') {
    throw "The staged INF is not version 100.6.101.58043: $infPath"
}
...
$result = [pscustomobject]@{
    ...
    PackageVersion = '100.6.101.58043'
