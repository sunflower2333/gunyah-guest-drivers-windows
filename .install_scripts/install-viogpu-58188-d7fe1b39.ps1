[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\USER\viogpu-58188-d7fe1b39\package',
    [string]$CertificatePath = 'C:\Users\USER\viogpu-58188-d7fe1b39\DroidVM_Test.cer',
    [string]$EvidenceRoot = 'C:\Users\USER\viogpu-58188-d7fe1b39\evidence',
...
$expectedHashes = [ordered]@{
    'viogpud3d.dll' = 'd89f3d930dfe4d0eb3480f3b7495243e7c6805eb3d94d11fc497e7c180345474'
    ...
    'viogpuwddm.sys' = 'b699bb08b055034fe72b1e6676993fb0d0152f663330fa9c34db0820231d40ca'
}
$expectedCertificateHash = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
$expectedVersion = '100.6.101.58188'
$expectedBeforeVersion = '100.6.101.58187'
$expectedBeforeInfPath = 'oem23.inf'
$expectedBeforeImageHash = 'd0320f7bedd739232f761a256d42b11f12f92b6a98551c2140e6efe27ef7543d'
$expectedBeforeUmdHash = 'adc830091dc35049b6b4adf5c07d16e8f284b5983787f93d08c7a89b8d898a53'
...
function Assert-Package {
    ...
    if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58188') { throw "The staged INF is not version $expectedVersion" }
