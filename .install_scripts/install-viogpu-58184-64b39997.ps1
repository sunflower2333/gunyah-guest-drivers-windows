[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\USER\viogpu-58184-64b39997\package',
    [string]$CertificatePath = 'C:\Users\USER\viogpu-58184-64b39997\DroidVM_Test.cer',
    [string]$EvidenceRoot = 'C:\Users\USER\viogpu-58184-64b39997\evidence',
    [string]$RollbackRoot = 'C:\Users\USER\viogpu-rollback-pre-58184-64b39997',
    [switch]$ValidateOnly
)
...
$expectedHashes = [ordered]@{
    'viogpud3d.dll' = '863786d7f14e354c74aa7c1a2827f2da54b9a80da7415cdde76015eb969e9e77'
    'viogpud3d.pdb' = 'b7c0f43b24ddee744728f71feb27b86a5bfdbfa5626856846b97de25d42ebb16'
    'viogpuwddm.cat' = '6df481d9b72f09ed80176ae3124101c2063caa0301ebb1b5fc64b619c9dc5805'
    'viogpuwddm.inf' = '97219412f3fa660dc0e9ba5794ff25b1403e32622a35a1a6784b85027b5ebf61'
    'viogpuwddm.map' = '71e40fe611f278e1dbf7e7b7a8ca57c7897cfd3a987b0af3e039b4e981af12b7'
    'viogpuwddm.pdb' = 'f47f0451713db5cf282052804dfe394dc6090900446488d9e699ac9e959a9141'
    'viogpuwddm.sys' = 'f7c5ef8dff97a5e6af0a8788cadce60297c8d1524ad186d96708328581809ef6'
}
$expectedCertificateHash = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
$expectedVersion = '100.6.101.58184'
...
function Assert-Package {
    ...
    if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58184') { throw "The staged INF is not version $expectedVersion" }
