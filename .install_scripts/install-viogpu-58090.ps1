[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\Administrator\viogpu-58090'
)

$ErrorActionPreference = 'Stop'
Set-StrictMode -Version Latest

$expectedVersion = '100.6.101.58090'
$expected = [ordered]@{
    'DroidVM_Test.cer' = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
    'drivers\viogpu\viogpuwddm.inf' = 'b774017393fdd6a513382ca4be32828d62479acf8461911b18b99c108d3ad35e'
    'drivers\viogpu\viogpuwddm.cat' = '0fe6afd468b127f2a419402f4139f2ed94657dd921375d7b0093a4a03f659579'
    'drivers\viogpu\viogpuwddm.sys' = '18bfe872475f02ba1cd59bdbd48a03e19a2c3dacd63199ce2fe4a4f90ca26433'
    'drivers\viogpu\viogpud3d.dll' = 'fcfaadf5af14547b13d02aa1be7afd12394f8aca5541c95643e89b49f19ece5c'
}
...
if ($infText -notmatch ("DriverVer\s*=\s*08/25/2026,\s*" + [regex]::Escape($expectedVersion))) {
