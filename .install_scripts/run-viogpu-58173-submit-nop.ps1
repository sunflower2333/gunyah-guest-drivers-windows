[CmdletBinding()]
param(
    [string]$ProbePath = 'C:\Users\USER\viogpu-58173-c5c742f6\kmt\tu_wddm_kmt_probe_arm64.exe',
    [string]$OutputDirectory = 'C:\Users\USER\viogpu-58173-c5c742f6\kmt-submit-nop',
    [int]$ProbeTimeoutMilliseconds = 30000
)

$ErrorActionPreference = 'Stop'
Set-StrictMode -Version Latest

$expectedProbeHash = '799d56d28db7bcd06babcc4b6c6bb2350d97c2f8c70c386e11f92e5315dcf555'
$expectedDriverVersion = '100.6.101.58173'
$expectedDriverHash = '6d5705699873b9cc1061e701ddfa8246dd6143051022ce7b8b1d1cbaafbdc8dd'
...
$traceName = "DroidVM-VioGpu-58173-SubmitNop-$stamp"
$etlPath = Join-Path $OutputDirectory "submit-nop-$stamp.etl"
$stdoutPath = Join-Path $OutputDirectory "submit-nop-$stamp.stdout.txt"
$stderrPath = Join-Path $OutputDirectory "submit-nop-$stamp.stderr.txt"
$resultPath = Join-Path $OutputDirectory "submit-nop-$stamp.result.json"
$traceStarted = $false
$probeProcessId = $null
$probeExitCode = $null
$timedOut = $false
...
try {
    ...
    $probe = Start-Process -FilePath $ProbePath -WorkingDirectory (Split-Path $ProbePath) `
        -ArgumentList @('--stage=allocation', '--submit-nop') -PassThru `
