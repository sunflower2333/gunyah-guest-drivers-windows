[CmdletBinding()]
param(
    [string]$ProbePath = 'C:\Users\USER\viogpu-58177-de51607b\kmt\tu_wddm_kmt_probe_arm64.exe',
    [string]$OutputDirectory = 'C:\Users\USER\viogpu-58177-de51607b\stress',
...
$expectedDriverVersion = '100.6.101.58177'
$expectedDriverHash = 'f98d0c306be1b1d36f5550be79e83ae2cd12ebbf9f3efd913792c9dc9cb9dd77'
...
$traceName = "DroidVM-VioGpu-58177-Stress-$stamp"
