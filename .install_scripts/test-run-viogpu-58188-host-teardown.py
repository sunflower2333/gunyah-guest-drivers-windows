...
SCRIPT = SCRIPT_DIR / "run-viogpu-58188-host-teardown.sh"
CAPTURE_HASH = "d45cc3a8377f72544a1f97488b5118ee7a33b4bf469801053e44faff581ef635"
TURNIP_HASH = "37bfd999a8825019311a8e3aa87ee30cc8fc1a9ab0076ad9b7c5110f112136c3"
DRIVER_HASH = "78e61f69787185fda68754842b0a46e4de8cf265e77139401b7a9b66537eaf37"
UMD_HASH = "cc69318eec054240e73e4fc7c4a243c4fd33349915a361ec9a4d51f9e308e108"
...
""",
        ...
        environment.update(
            {
                ...
                "WINDOWS_RUNNER": "C:/Users/USER/viogpu-58193-b70a09c0/run-viogpu-58188-turnip.ps1",
                "DRIVER_VERSION": "100.6.101.58193",
                "DRIVER_IMAGE_SHA256": DRIVER_HASH,
                "UMD_IMAGE_SHA256": UMD_HASH,
                "SKIP_INTERACTIVE": "1",
            }
        )
    ...
    def test_complete_workload_and_host_teardown_pass(self):
        ...
        self.assertIn("-DriverVersion 100.6.101.58193", ssh_arguments)
        self.assertIn(f"-DriverImageSha256 {DRIVER_HASH}", ssh_arguments)
        self.assertIn(f"-UmdImageSha256 {UMD_HASH}", ssh_arguments)
        self.assertIn("-SkipInteractive", ssh_arguments)
