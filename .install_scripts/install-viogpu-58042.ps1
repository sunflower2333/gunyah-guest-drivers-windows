[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\DroidVM\viogpu-58042\viogpu',
    [string]$CertificatePath = 'C:\DroidVM\viogpu-58042\DroidVM_Test.cer',
    [string]$OutputDirectory = 'C:\DroidVM\viogpu-58042\runtime-logs'
)
...
$expectedHashes = [ordered]@{
    'viogpuwddm.sys' = '91c33a720884b31b6e4517fd4a24cede01eaf8daa2d4427d6289bf4a61a29e8a'
    'viogpud3d.dll' = '8a5e0d421b0fc61af44b19e588d54444141dccb82bfc628cd880fc09244ceb7b'
    'viogpuwddm.cat' = 'c02a26514c2fe50d66bb7ea8d77f0d8bb12ab44019d81a36bcd1179321b82a3d'
    'viogpuwddm.inf' = '82b6c1428ec171ba51d416a9906a2417689b2c0f03edd3feee4f23f4ea0491dd'
    'viogpuwddm.pdb' = '98df7ae3e49b9f0fd330a04acb2ca42bc3fa5301e099b2b5a1850df35f9abae2'
    'viogpuwddm.map' = '403ce4e6a8b2ed72649e4eb28c592bb1c7934c4e33142c428f3f66fe3b7903f0'
    'viogpud3d.pdb' = 'c49c45de0b0518e8e4864c1b202ae72b84f0a82464cdcebf114277638b27e387'
}
...
if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58042') {
    throw "The staged INF is not version 100.6.101.58042: $infPath"
}
...
$result = [pscustomobject]@{
    ...
    PackageVersion = '100.6.101.58042'
