[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\USER\viogpu-58181-97214dc5\package',
    [string]$CertificatePath = 'C:\Users\USER\viogpu-58181-97214dc5\DroidVM_Test.cer',
    [string]$EvidenceRoot = 'C:\Users\USER\viogpu-58181-97214dc5\evidence',
    [string]$RollbackRoot = 'C:\Users\USER\viogpu-rollback-pre-58181-97214dc5',
    [switch]$ValidateOnly
)
...
$expectedHashes = [ordered]@{
    'viogpud3d.dll' = '9d4ab844a59940868f9848904240857e4885853cc9a2aa0b86a706bd9a9ebdee'
    'viogpud3d.pdb' = '46fa409168e050cb24175462781cabd320f7d09299784986d7e6582a49b87c00'
    'viogpuwddm.cat' = '1f70c060553d7171c0cf36e9421bbac80609b27250cd5d1fd09badedd47b0640'
    'viogpuwddm.inf' = '1b5965a34f27ff976975a485e16a5b0dc6bec4d34f9fe13eb37ab4bc74de8d7d'
    'viogpuwddm.map' = '4a726488ade4500654e3bd48253853b9486382d7385f51445c797561d4af0b71'
    'viogpuwddm.pdb' = '9bc3f4189651623d799f7027c5590d9bcb97b76739377dfd778710ab259a511b'
    'viogpuwddm.sys' = '55e55132e78bed160dca8641aa3b674db2e67fcf6421154d5936552ff17a8625'
}
$expectedCertificateHash = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
$expectedVersion = '100.6.101.58181'
...
function Assert-Package {
    ...
    if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58181') { throw "The staged INF is not version $expectedVersion" }
