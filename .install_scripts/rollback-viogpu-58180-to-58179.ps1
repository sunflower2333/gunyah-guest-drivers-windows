...
$expectedCurrentVersion = '100.6.101.58180'
$expectedCurrentImageHash = 'cbaa70090a150200b6a93f078be5a74ec302d222ef149cd35d06e7598b372524'
$expectedCurrentUmdHash = '96f47b5544ec950b7166d0f85052b4f574328786a13143c3a12c4d94ca7eae5b'
$expectedRollbackVersion = '100.6.101.58179'
...
if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58179') { throw "Rollback INF is not version $expectedRollbackVersion" }
