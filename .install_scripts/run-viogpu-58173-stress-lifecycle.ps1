[CmdletBinding()]
param(
    [string]$ProbePath = 'C:\Users\USER\viogpu-58173-corrected-20260830\kmt\tu_wddm_kmt_probe_arm64.exe',
    [string]$OutputDirectory = 'C:\Users\USER\viogpu-58173-stress-20260830',
...
$expectedProbeHash = '8ed3ff2ba1c3c95b1ed93b278f3c4c3022797f36853166ee0797f4dc183dbc11'
...
$traceName = "DroidVM-VioGpu-58173-Stress-$stamp"
...
if ($probeExitCode -eq 0 -and -not $probeReportedPass) {
    # A process exit of zero is not sufficient evidence when the probe is
    # launched through Start-Process/SSH.  Preserve the raw exit code, but
    # fail the wrapper if the probe did not print its terminal pass marker.
    $probeExitCode = 1
}
$result = [ordered]@{
