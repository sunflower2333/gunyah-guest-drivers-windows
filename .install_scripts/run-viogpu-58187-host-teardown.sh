...
evidence_dir=$1
windows_output=${2:-C:/DroidVM/TurnipRuns/evidence/viogpu-58187-b5b217b1-host-$(date -u +%Y%m%dT%H%M%SZ)}
adb_bin=${ADB_BIN:-adb}
ssh_bin=${SSH_BIN:-ssh}
...
turnip_runner=$script_dir/run-viogpu-58187-turnip.ps1
windows_runner=C:/Users/USER/viogpu-58187-b5b217b1/run-viogpu-58187-turnip.ps1
...
expected_turnip_hash=b9dc1953dc64e779a253d92fbafc5eca6903018f2469de395f0bec7ea378f990
