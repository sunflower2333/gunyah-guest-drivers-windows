...
param(
    ...
    [string]$OutputDirectory = 'C:\DroidVM\TurnipRuns\evidence\viogpu-58187-b5b217b1-kmt-retry900s',
    [int]$StressTimeoutMilliseconds = 900000,
...
function Invoke-KmtPhase {
    ...
    $traceName = "DroidVM-VioGpu-58187-$Name-$stamp"
