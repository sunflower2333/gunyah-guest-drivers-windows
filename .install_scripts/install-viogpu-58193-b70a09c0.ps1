[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\USER\viogpu-58193-b70a09c0\package',
    [string]$CertificatePath = 'C:\Users\USER\viogpu-58193-b70a09c0\DroidVM_Test.cer',
    [string]$EvidenceRoot = 'C:\Users\USER\viogpu-58193-b70a09c0\evidence',
    [string]$RollbackRoot = 'C:\Users\USER\viogpu-rollback-pre-58193-b70a09c0',
    [switch]$ValidateOnly
)
...
$expectedHashes = [ordered]@{
    'viogpud3d.dll' = 'cc69318eec054240e73e4fc7c4a243c4fd33349915a361ec9a4d51f9e308e108'
    ...
    'viogpuwddm.sys' = '78e61f69787185fda68754842b0a46e4de8cf265e77139401b7a9b66537eaf37'
}
$expectedCertificateHash = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
$expectedVersion = '100.6.101.58193'
$expectedBeforeVersion = '100.6.101.58192'
$expectedBeforeInfPath = 'oem27.inf'
$expectedBeforeImageHash = '09afe04f9a1b83de5a40c5efa6324e664d466238219c8a2b0f5c60531be98b4d'
$expectedBeforeUmdHash = 'efcb7b56431be589193ee67c509b182ebf7ba537d956344d873451e33936a475'
...
function Assert-Package {
    ...
    if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58193') { throw "The staged INF is not version $expectedVersion" }
...
if ($before.DriverVersion -ne $expectedBeforeVersion -or
    ...
    $null -eq $before.ServiceParametersRenderOnly -or [int]$before.ServiceParametersRenderOnly -ne 1 -or
