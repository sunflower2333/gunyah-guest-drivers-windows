[CmdletBinding()]
param(
    [string]$PackageRoot = 'C:\Users\Administrator\viogpu-58062'
)

$ErrorActionPreference = 'Stop'
Set-StrictMode -Version Latest

$expectedVersion = '100.6.101.58062'
$expected = [ordered]@{
    'DroidVM_Test.cer' = 'da88f450dbd881c91511c5b801295cd9cc0d3ca84ea9d3dc08eff9481eed64b3'
    'viogpuwddm.inf' = '3415b6ac9ab9f8829b3cb59dffc8ee03f66b8db62b0744df0a1381da36ca0d3e'
    'viogpuwddm.cat' = '948db6754cccebefa3574c173f98ed21abaeaf68055decfc31fa8bc5713fd2f4'
    'viogpuwddm.sys' = '1784ce3fc2cee026bcd800e968d39c725e0c894eecdd6d87598deeb0ffbe1dab'
    'viogpud3d.dll' = '2847ba07d5379afd518741ddbb595b48070cc027742d79ae7f00970ae08e923e'
}
...
function Get-VioGpuSnapshot {
    ...
    $problem = if ($null -ne $device.PSObject.Properties['Problem']) {
...
if ($infText -notmatch 'DriverVer\s*=\s*[^,]+,100\.6\.101\.58062') {
...
if ($after.Status -ne 'OK' -or ($null -ne $after.ProblemCode -and $after.ProblemCode -ne 0)) {
    throw "Driver is not healthy after install: status=$($after.Status), problem=$($after.Problem), code=$($after.ProblemCode)."
}
