...
ABI_VALUE(virtio.cmd.resource_map_blob, VIRTIO_GPU_CMD_RESOURCE_MAP_BLOB, 520);
ABI_VALUE(virtio.cmd.resource_unmap_blob, VIRTIO_GPU_CMD_RESOURCE_UNMAP_BLOB, 521);
...
ABI_VALUE(virtio.resp.ok_map_info, VIRTIO_GPU_RESP_OK_MAP_INFO, 4358);
...
ABI_VALUE(virtio.blob_mem.host3d, VIRTIO_GPU_BLOB_MEM_HOST3D, 2);
...
ABI_VALUE(msm.param.va_size, MSM_PARAM_VA_SIZE, 15);
ABI_VALUE(msm.ioctl.get_param, DRM_IOCTL_MSM_GET_PARAM, 3222824000ULL);
ABI_VALUE(msm.submitqueue.allow_preempt, MSM_SUBMITQUEUE_ALLOW_PREEMPT, 1);
ABI_VALUE(msm.ioctl.submitqueue_new, DRM_IOCTL_MSM_SUBMITQUEUE_NEW, 3222037578ULL);
ABI_VALUE(msm.ioctl.submitqueue_close, DRM_IOCTL_MSM_SUBMITQUEUE_CLOSE, 1074029643ULL);
...
ABI_SIZE(size.drm_msm_param, struct drm_msm_param, 24);
ABI_OFFSET(offset.drm_msm_param.pipe, struct drm_msm_param, pipe, 0);
ABI_OFFSET(offset.drm_msm_param.param, struct drm_msm_param, param, 4);
ABI_OFFSET(offset.drm_msm_param.value, struct drm_msm_param, value, 8);
ABI_OFFSET(offset.drm_msm_param.len, struct drm_msm_param, len, 16);
ABI_OFFSET(offset.drm_msm_param.pad, struct drm_msm_param, pad, 20);
ABI_SIZE(size.msm_ccmd_ioctl_simple_get_param_req, ABI_GET_PARAM_REQ, 44);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_req.hdr, ABI_GET_PARAM_REQ, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_req.ioctl_cmd, ABI_GET_PARAM_REQ, ioctl_cmd, 16);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_req.param, ABI_GET_PARAM_REQ, param, 20);
ABI_SIZE(size.msm_ccmd_ioctl_simple_get_param_rsp, ABI_GET_PARAM_RSP, 32);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_rsp.hdr, ABI_GET_PARAM_RSP, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_rsp.ret, ABI_GET_PARAM_RSP, ret, 4);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_get_param_rsp.param, ABI_GET_PARAM_RSP, param, 8);
ABI_SIZE(size.drm_msm_submitqueue, struct drm_msm_submitqueue, 12);
ABI_OFFSET(offset.drm_msm_submitqueue.flags, struct drm_msm_submitqueue, flags, 0);
ABI_OFFSET(offset.drm_msm_submitqueue.prio, struct drm_msm_submitqueue, prio, 4);
ABI_OFFSET(offset.drm_msm_submitqueue.id, struct drm_msm_submitqueue, id, 8);
ABI_SIZE(size.msm_ccmd_ioctl_simple_submitqueue_new_req, ABI_SUBMITQUEUE_NEW_REQ, 32);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_req.hdr, ABI_SUBMITQUEUE_NEW_REQ, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_req.ioctl_cmd, ABI_SUBMITQUEUE_NEW_REQ, ioctl_cmd, 16);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_req.submitqueue, ABI_SUBMITQUEUE_NEW_REQ, submitqueue, 20);
ABI_SIZE(size.msm_ccmd_ioctl_simple_submitqueue_new_rsp, ABI_SUBMITQUEUE_NEW_RSP, 20);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_rsp.hdr, ABI_SUBMITQUEUE_NEW_RSP, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_rsp.ret, ABI_SUBMITQUEUE_NEW_RSP, ret, 4);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_new_rsp.submitqueue, ABI_SUBMITQUEUE_NEW_RSP, submitqueue, 8);
ABI_SIZE(size.msm_ccmd_ioctl_simple_submitqueue_close_req, ABI_SUBMITQUEUE_CLOSE_REQ, 24);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_close_req.hdr, ABI_SUBMITQUEUE_CLOSE_REQ, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_close_req.ioctl_cmd, ABI_SUBMITQUEUE_CLOSE_REQ, ioctl_cmd, 16);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_close_req.queue_id, ABI_SUBMITQUEUE_CLOSE_REQ, queue_id, 20);
ABI_SIZE(size.msm_ccmd_ioctl_simple_submitqueue_close_rsp, ABI_SUBMITQUEUE_CLOSE_RSP, 8);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_close_rsp.hdr, ABI_SUBMITQUEUE_CLOSE_RSP, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_submitqueue_close_rsp.ret, ABI_SUBMITQUEUE_CLOSE_RSP, ret, 4);
