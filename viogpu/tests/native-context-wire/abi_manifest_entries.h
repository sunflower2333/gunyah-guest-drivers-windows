...
ABI_OFFSET(offset.capset_drm.msm.has_cached_coherent, ABI_CAPSET, ABI_CAPSET_MSM.has_cached_coherent, 24);
...
ABI_OFFSET(offset.capset_drm.msm.highest_bank_bit, ABI_CAPSET, ABI_CAPSET_MSM.highest_bank_bit, 76);
ABI_OFFSET(offset.capset_drm.msm.ubwc_swizzle, ABI_CAPSET, ABI_CAPSET_MSM.ubwc_swizzle, 80);
ABI_OFFSET(offset.capset_drm.msm.macrotile_mode, ABI_CAPSET, ABI_CAPSET_MSM.macrotile_mode, 88);
ABI_OFFSET(offset.capset_drm.msm.has_raytracing, ABI_CAPSET, ABI_CAPSET_MSM.has_raytracing, 96);
ABI_OFFSET(offset.capset_drm.msm.has_preemption, ABI_CAPSET, ABI_CAPSET_MSM.has_preemption, 100);
ABI_OFFSET(offset.capset_drm.msm.uche_trap_base, ABI_CAPSET, ABI_CAPSET_MSM.uche_trap_base, 104);
ABI_EXPR(extent.capset_drm_msm, offsetof(ABI_CAPSET, ABI_CAPSET_MSM) + sizeof(((ABI_CAPSET *)0)->ABI_CAPSET_MSM), 112);
...
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_req.payload, struct msm_ccmd_ioctl_simple_req, payload, 20);
...
ABI_OFFSET(offset.msm_ccmd_ioctl_simple_rsp.payload, struct msm_ccmd_ioctl_simple_rsp, payload, 8);
...
ABI_OFFSET(offset.msm_ccmd_gem_new_run_list.nr_runs, struct msm_ccmd_gem_new_run_list, nr_runs, 0);
ABI_OFFSET(offset.msm_ccmd_gem_new_run_list.pad, struct msm_ccmd_gem_new_run_list, pad, 4);
ABI_OFFSET(offset.msm_ccmd_gem_new_run_list.runs, struct msm_ccmd_gem_new_run_list, runs, 8);
...
ABI_OFFSET(offset.msm_ccmd_gem_set_iova_req.res_id, struct msm_ccmd_gem_set_iova_req, res_id, 24);
...
ABI_OFFSET(offset.msm_ccmd_gem_cpu_prep_req.res_id, struct msm_ccmd_gem_cpu_prep_req, res_id, 16);
...
ABI_OFFSET(offset.msm_ccmd_gem_set_name_req.res_id, struct msm_ccmd_gem_set_name_req, res_id, 16);
ABI_OFFSET(offset.msm_ccmd_gem_set_name_req.len, struct msm_ccmd_gem_set_name_req, len, 20);
ABI_OFFSET(offset.msm_ccmd_gem_set_name_req.payload, struct msm_ccmd_gem_set_name_req, payload, 24);
...
ABI_OFFSET(offset.msm_ccmd_gem_submit_req.queue_id, struct msm_ccmd_gem_submit_req, queue_id, 20);
ABI_OFFSET(offset.msm_ccmd_gem_submit_req.nr_bos, struct msm_ccmd_gem_submit_req, nr_bos, 24);
ABI_OFFSET(offset.msm_ccmd_gem_submit_req.nr_cmds, struct msm_ccmd_gem_submit_req, nr_cmds, 28);
ABI_OFFSET(offset.msm_ccmd_gem_submit_req.fence, struct msm_ccmd_gem_submit_req, fence, 32);
ABI_OFFSET(offset.msm_ccmd_gem_submit_req.payload, struct msm_ccmd_gem_submit_req, payload, 36);
...
ABI_OFFSET(offset.msm_ccmd_gem_upload_req.payload, struct msm_ccmd_gem_upload_req, payload, 32);

ABI_SIZE(size.msm_ccmd_submitqueue_query_req, struct msm_ccmd_submitqueue_query_req, 28);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_req.hdr, struct msm_ccmd_submitqueue_query_req, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_req.queue_id, struct msm_ccmd_submitqueue_query_req, queue_id, 16);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_req.param, struct msm_ccmd_submitqueue_query_req, param, 20);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_req.len, struct msm_ccmd_submitqueue_query_req, len, 24);
ABI_SIZE(size.msm_ccmd_submitqueue_query_rsp, struct msm_ccmd_submitqueue_query_rsp, 12);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_rsp.hdr, struct msm_ccmd_submitqueue_query_rsp, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_rsp.ret, struct msm_ccmd_submitqueue_query_rsp, ret, 4);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_rsp.out_len, struct msm_ccmd_submitqueue_query_rsp, out_len, 8);
ABI_OFFSET(offset.msm_ccmd_submitqueue_query_rsp.payload, struct msm_ccmd_submitqueue_query_rsp, payload, 12);
...
ABI_OFFSET(offset.msm_ccmd_wait_fence_req.queue_id, struct msm_ccmd_wait_fence_req, queue_id, 16);
ABI_OFFSET(offset.msm_ccmd_wait_fence_req.fence, struct msm_ccmd_wait_fence_req, fence, 20);
...
ABI_OFFSET(offset.msm_ccmd_set_debuginfo_req.hdr, struct msm_ccmd_set_debuginfo_req, hdr, 0);
ABI_OFFSET(offset.msm_ccmd_set_debuginfo_req.comm_len, struct msm_ccmd_set_debuginfo_req, comm_len, 16);
ABI_OFFSET(offset.msm_ccmd_set_debuginfo_req.cmdline_len, struct msm_ccmd_set_debuginfo_req, cmdline_len, 20);
ABI_OFFSET(offset.msm_ccmd_set_debuginfo_req.payload, struct msm_ccmd_set_debuginfo_req, payload, 24);
