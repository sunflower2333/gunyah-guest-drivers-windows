...
mutations = [
    ...
    ("link policy ignores FP16 scanout", "viogpu_display_color.h",
     lambda t: replace_once(t, "return VioGpuScRgbScanoutAdmitted(caps, canonicalFp16Scanout)",
                            "return VioGpuDisplayColorPqAdmitted(caps)"),
    ...
    ("HDR monitor mode without admission", "viogpudo.cpp",
     lambda t: replace_once(t, "if (QueryDisplayColor(&monitorCaps) && VioGpuScRgbScanoutAdmitted(&monitorCaps, true))",
