#!/usr/bin/env python3
"""Compile and execute the production child descriptor selection contract."""
...
source = Path(__file__).resolve().with_name("child_descriptor_test.cpp")
with tempfile.TemporaryDirectory(prefix="viogpu-child-descriptor-") as temporary:
