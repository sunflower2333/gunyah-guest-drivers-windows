#!/usr/bin/env python3
"""Compile and execute the MMIO flip classification and target policy."""
...
source = Path(__file__).resolve().with_name("mmio_flip_test.cpp")
with tempfile.TemporaryDirectory(prefix="viogpu-mmio-flip-") as temporary:
