...
/* DroidVM Native Display: host-owned Android gralloc allocation. */
#define VIRTIO_GPU_BLOB_FLAG_USE_NATIVE_AHB      0x0010U

#define VIRTIO_GPU_MAP_CACHE_CACHED              0x0001U
#define VIRTIO_GPU_CMD_RESOURCE_CREATE_NATIVE_AHB 0xd211U
#define VIRTIO_GPU_RESP_OK_NATIVE_AHB            0xd212U
#define VIRTIO_GPU_NATIVE_AHB_REQUEST_VERSION    2U
#define VIRTIO_GPU_NATIVE_AHB_REQUEST_BODY_SIZE  24U
#define VIRTIO_GPU_NATIVE_AHB_REQUEST_WIRE_SIZE  52U
#define VIRTIO_GPU_NATIVE_AHB_RESPONSE_WIRE_SIZE 88U
#define VIRTIO_GPU_CMD_PRESENT_NATIVE_AHB        0xd213U
#define VIRTIO_GPU_CMD_REFRESH_NATIVE_AHB        0xd218U
...
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_CMD_RESOURCE_CREATE_NATIVE_AHB, 0xd211);
...
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_RESP_OK_NATIVE_AHB, 0xd212);
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_F_NATIVE_AHB_RELEASE, 8);
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_CMD_PRESENT_NATIVE_AHB, 0xd213);
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_CMD_WAIT_NATIVE_AHB_RELEASE, 0xd214);
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_RESP_OK_NATIVE_AHB_OPERATION, 0xd215);
VIOGPU_WIRE_ASSERT_VALUE(VIRTIO_GPU_NATIVE_AHB_OPERATION_WIRE_SIZE, 40);
