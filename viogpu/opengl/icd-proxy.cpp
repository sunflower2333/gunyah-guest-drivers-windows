...
{
    if (!InitOnceExecuteOnce(&modules_once, initialize_modules, nullptr, nullptr))
    {
        return FALSE;
    }
...
{
    if (!InitOnceExecuteOnce(&gallium_once, initialize_gallium, nullptr, nullptr))
    {
        return nullptr;
    }
...
{
    auto entry = vk_entry<decltype(&vk_icdNegotiateLoaderICDInterfaceVersion)>("vk_"
                                                                               "icdNegotiateLoaderICDInterfaceVersion");
