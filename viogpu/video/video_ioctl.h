...
#define VGPU_VIDEO_INTERFACE_GUID_INIT {0xd4f38a6c,0xa175,0x4d6f,{0x94,0xeb,0x73,0x62,0x20,0xc8,0x3e,0x51}}
#pragma pack(push,8)
typedef struct VGPU_VIDEO_HEADER { uint32_t Version, Size; uint64_t Generation; } VGPU_VIDEO_HEADER;
typedef struct VGPU_VIDEO_OPEN { VGPU_VIDEO_HEADER Header; VMEDIA_CONFIG Config; } VGPU_VIDEO_OPEN;
