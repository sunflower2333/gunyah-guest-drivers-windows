...
DXGKDDI_CALIBRATEGPUCLOCK VioGpuWddmCalibrateGpuClock;
DXGKDDI_SETSTABLEPOWERSTATE VioGpuWddmSetStablePowerState;
...
#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WDDM2_3)
DXGKDDI_SETVIDPNSOURCEADDRESSWITHMULTIPLANEOVERLAY3 VioGpuWddmSetVidPnSourceAddressMpo3;
DXGKDDI_SETTARGETADJUSTEDCOLORIMETRY VioGpuWddmSetTargetAdjustedColorimetry;
DXGKDDI_CHECKMULTIPLANEOVERLAYSUPPORT3 VioGpuWddmCheckMultiPlaneOverlaySupport3;
DXGKDDI_SETTIMINGSFROMVIDPN VioGpuWddmSetTimingsFromVidPn;
DXGKDDI_SETTARGETGAMMA VioGpuWddmSetTargetGamma;
DXGKDDI_UPDATEMONITORLINKINFO VioGpuWddmUpdateMonitorLinkInfo;
#if defined(VIOGPU_ADVANCED_COLOR_CONNECTION_DDIS)
DXGKDDI_DISPLAYDETECTCONTROL VioGpuWddmDisplayDetectControl;
DXGKDDI_QUERYCONNECTIONCHANGE VioGpuWddmQueryConnectionChange;
#endif
#endif
