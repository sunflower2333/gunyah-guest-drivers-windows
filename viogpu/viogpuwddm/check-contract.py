...
def check_arm64_workflow_contract() -> None:
    ...
    product_version_fragments = (
        ...
        "[int]$env:DROIDVM_DRIVER_MINOR -ne 58568",
...
def check_legacy_runtime_callback_contract() -> None:
    ...
    for fragment in (
        ...
        "constVIOGPU_VBLANK_CLOCKclock=m_CrtcVblankClock;",
        "constULONGLONGinterruptNow=KeQueryInterruptTimePrecise(&qpc);",
        "if(armed){if(!VioGpuVblankPosition(interruptNow,clock,position))",
